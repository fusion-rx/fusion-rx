/**
 * Maps timezones to their descriptions.
 */
export const timezones: Record<Timezone, TimezoneDescription> = {
    MIT: 'West Samoa Time',
...
/**
 * Validates if `timezone` is of type Timezone.
 * @param timezone A value, potentially of type Timezone
 * @returns Type validation for `timeZone`
 */
export const isTimezone = (timezone: any): timezone is Timezone =>
    Object.keys(timezones).includes(timezone);

/**
 * The string values of all timezones.
 */
...
/**
 * Validates if `timezoneDescription` is of type TimezoneDescription.
 * @param timezone A value, potentially of type TimezoneDescription
 * @returns Type validation for `timezoneDescription`
 */
export const isTimezoneDescription = (
    timezoneDescription: any
): timezoneDescription is TimezoneDescription =>
    Object.values(timezones).includes(timezoneDescription);

/**
 * The string values of timezone descriptions.
 */
