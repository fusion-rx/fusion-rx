...
import { Inject, Injectable, Optional, afterAppInit } from '@fusion-rx/core';
import {
    Observable,
    Subscription,
    catchError,
...
import { expressApp, listen } from './listen.js';
import {
    ParamType,
    RequestDef,
    RequestDefWithBody,
...
import { HttpStatusCode } from '../public-api.js';
...
afterAppInit.subscribe(() => {
    listen('localhost', 4100);
});
