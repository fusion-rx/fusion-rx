...
export class HttpRequest<T> {
    ...
    /**
     * The native Fetch options for the request
     */
    ...
    constructor(
        ...
        // options, if any.
        let options: (HttpRequestInit & FetchOptions) | undefined;
        ...
        if (mightHaveBody(this.method) || !!fourth) {
            ...
            options = third as HttpRequestInit & FetchOptions;
        }
        ...
        if (options) {
            ...
            // We do also want to assign fetchOptions, substituting an empty object if its falsy
            this.fetchOptions = {
